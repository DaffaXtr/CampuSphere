            ...
            <form className="space-y-lg md:space-y-2xl">
              ...
              <div className="space-y-md">
                <div className="flex items-center gap-sm border-b border-border pb-2">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-text-primary">Pilihan Peran</h3>
                </div>
              ...
              <div className="space-y-md">
                <div className="flex items-center gap-sm border-b border-border pb-2">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-text-primary">Persyaratan Wajib</h3>
                </div>
                <div className="flex flex-col gap-sm">
                  <label className="flex items-start gap-3 p-3 rounded-lg bg-surface hover:bg-surface-container transition-colors cursor-pointer">
                    ...
                    <span className="text-[12px] md:text-body-md text-text-primary">Saya terdaftar di setidaknya satu mata kuliah terkait STEM semester ini.</span>
                  </label>
                  <label className="flex items-start gap-3 p-3 rounded-lg bg-surface hover:bg-surface-container transition-colors cursor-pointer">
                    <input type="checkbox" className="mt-1 w-4 h-4 rounded text-primary focus:ring-primary" />
                    <span className="text-[12px] md:text-body-md text-text-primary">Saya memiliki kemahiran dasar dalam Git/GitHub dan alur kerja kolaboratif.</span>
                  </label>
                  <label className="flex items-start gap-3 p-3 rounded-lg bg-surface hover:bg-surface-container transition-colors cursor-pointer">
                    <input type="checkbox" className="mt-1 w-4 h-4 rounded text-primary focus:ring-primary" />
                    <span className="text-[12px] md:text-body-md text-text-primary">Saya bersedia dan mampu meluangkan waktu 5-10 jam per minggu untuk proyek klub.</span>
                  </label>
                </div>
              </div>
              ...
              <div className="space-y-md">
                <div className="flex items-center gap-sm border-b border-border pb-2">
                  ...
                  <h3 className="font-headline-sm text-headline-sm text-text-primary">Portofolio & Resume</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-md md:gap-lg">
                  <div className="flex flex-col gap-xs md:gap-sm">
                    <label className="font-label-md text-label-md text-text-primary">Tautan Portofolio (GitHub, Behance, dll.)</label>
                    <input className="w-full h-10 md:h-12 px-md rounded-lg border border-border focus:border-primary outline-none focus:ring-1 focus:ring-primary transition-all text-[13px] md:font-body-md md:text-body-md" placeholder="https://github.com/username-anda" type="url" />
                  </div>
                  <div className="flex flex-col gap-xs md:gap-sm">
                    <label className="font-label-md text-label-md text-text-primary">Unggah Resume / CV (PDF maks. 5MB)</label>
            ...
            <div className="p-md md:p-lg flex flex-col gap-md md:gap-lg">
              ...
              <div className="border-t border-border pt-md md:pt-lg">
                ...
                <div className="flex items-start gap-sm mt-md mb-xl">
                  ...
                  <p className="text-[10px] md:font-body-sm md:text-body-sm text-text-secondary">Pastikan semua persyaratan wajib telah dicentang dan portofolio telah disediakan sebelum melanjutkan.</p>
                </div>
                
                <Link to={`/recruitment/${id || 1}/apply/step3`} className="w-full bg-primary text-on-primary font-bold text-[13px] md:font-label-md md:text-label-md py-sm md:py-md rounded-lg hover:bg-primary-hover active:scale-95 transition-all flex items-center justify-center gap-xs md:gap-sm cursor-pointer">
                  Kirim Lamaran
